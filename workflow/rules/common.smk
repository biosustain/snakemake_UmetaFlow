...
def get_final_output():
    ...
    rule_dict = {"fileconversion" : expand(os.path.join("data", "mzML", "{dataset}.mzML"), dataset=DATASET),
        ...
        expand(os.path.join("results", "Interim", "Preprocessed", "consenus_features_unfiltered.consensusXML")),
        expand(os.path.join("results", "Interim", "Preprocessed", "consenus_features.consensusXML")),
        expand(os.path.join("results", "Interim", "Preprocessed", "FeatureMatrix.tsv")),
        ...
        expand(os.path.join("results", "Interim", "Requantified", "consenus_features_unfiltered.consensusXML")),
        expand(os.path.join("results", "Interim", "Requantified", "consenus_features.consensusXML")),
        expand(os.path.join("results", "Interim", "Requantified", "FeatureMatrix.tsv")),
